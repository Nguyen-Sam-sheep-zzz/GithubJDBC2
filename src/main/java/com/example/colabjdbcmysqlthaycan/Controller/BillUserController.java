...
public class BillUserController {
    ...
    public void loadToLoginScreenFromBill() throws IOException {
    ...
    public void loadToOrderScreenFromBill() throws IOException {
    ...
    public void loadToCartScreenFromBill() throws IOException {
